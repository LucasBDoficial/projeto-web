        ...
        <div className="container">
            <div className="row planos-box">
                ...
                <Card  className='card'>
                    ...
                    <Card.Body>
                        <Card.Title><h1>R$ 49,90 /mês</h1></Card.Title>
                        <Card.Text>Some quick example text to build on the card title and make up the bulk of the cards content.</Card.Text>
                            <br />
                        <Button variant="primary"><h3>Começar agora</h3></Button>
                    </Card.Body>
                ...
                <Card  className='card'>
                    ...
                    <Card.Body>
                        <Card.Title><h1>R$ 99,90 /mês</h1></Card.Title>
                        <Card.Text>Some quick example text to build on the card title and make up the bulk of the cards content.</Card.Text>
                            <br />
                        <Button variant="primary"><h3>Começar agora</h3></Button>
                    </Card.Body>
